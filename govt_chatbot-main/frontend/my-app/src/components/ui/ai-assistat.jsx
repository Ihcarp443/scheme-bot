...
import { Send, Sparkles, X, Loader2 ,Mic, Square, Trash, PlusCircleIcon, MessageSquarePlus} from "lucide-react";
...
const AIMessageBar = () => {
  ...
  try {
    ...
    const response = await fetch(
      "http://127.0.0.1:8000/grievance/resume",
      {
        method: "POST",
        headers: {
    ...
    <div className="w-[30%] bg-slate-900 border-r border-slate-800 flex flex-col">
      ...
      <div className="p-5 border-b border-slate-800">
        <div className="flex items-center justify-between">
          ...
          >
            <MessageSquarePlus size={20} color="white" strokeWidth={2} />
          </button>
        </div>
      </div>
        {/* PAST CHATS */}
...
//   const invokebackendInterrupt=async(userMessage)=>{
//     setIsTyping(true);
//      try {
//     //   complaint_data={
//     //     userMessage
...
//     console.log("body",body)
//     const res = await response.json();
//     console.log("Backend Response:", res.interrupt);
//     if (res.interrupt) {
//       console.log("Received interrupt");
//       console.log("Interrupt payload:", res.data);
//       setIsTyping(false)
//       setInterrupt(true);
//       console.log("Interrupt Data:", res);
//       setInterruptData(res.data);
//       setMessages((prev) => [
//         ...prev,
//         ...res.data.questions.map(q => ({
...
//     }
//     else{
//       setInterrupt(res.interrupt ?? false);
//       setIsTyping(false)
//       const fin=res.answer
//       setMessages((prev) => [...prev, { text: fin, isUser: false }]);
//     }
...
//     setInput("");
//     if(interrupt){
//       invokebackendInterrupt(userMessage)
//     }
//     else{
//       sendTextToBackend(userMessage,"text");
//     }
