...
#     memory = state.get("memory", {})
    ...
    #     You must classify the user query into exactly ONE of the following routes by looking at the description given under each section must follow those:
    ...
    #     - non scheme related conversation
    #     - never user for any query related to schemes
